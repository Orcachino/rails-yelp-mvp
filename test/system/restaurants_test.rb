...
class RestaurantsTest < ApplicationSystemTestCase
  ...
  test "creating a Restaurant" do
    ...
    fill_in "Interger", with: @restaurant.interger
    fill_in "Name", with: @restaurant.name
    fill_in "Phone Number", with: @restaurant.phone-number
    fill_in "Review", with: @restaurant.review
    fill_in "String", with: @restaurant.string
